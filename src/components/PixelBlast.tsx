...
// Define types for LiquidEffect and PixelBlast props
...
const PixelBlast = ({
  ...
  const threeRef = useRef<any>(null); // Use 'any' for simplicity with the complex Three.js object
      ...
      const animate = () => {
        ...
        if (composer) {
          ...
          composer.passes.forEach(p => {
            const effs = (p as any).effects; // Cast to any to access effects
            if (effs)
